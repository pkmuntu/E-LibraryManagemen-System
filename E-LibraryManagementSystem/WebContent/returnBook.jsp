...
<body class="main11">
  <div class="div0">
        <div class="div11" >
            <h4></h4>Return Book Form<hr><br>
              <form action="setReturnBook.jsp">
                  ...
                  <div class="form-group col-md-6">
                        ...
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="userid" >
                            ...
                            Statement stmt=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
                              ResultSet rs=stmt.executeQuery("select DISTINCT USERID FROM ISSUES_BOOKS");
                              while(rs.next())
                              {
                              %>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="bookName">
                            ...
                            <%
                              ...
                              ResultSet rss=stmt.executeQuery("select DISTINCT b.BOOKNAME from ISSUES_BOOKS i INNER JOIN BOOKS b ON i.BOOKID=b.ISBN");
                              while(rss.next())
                              {
                              %>
                ...
                <div class="form-group col-md-6">
                    <label for="">Return Date<b style="color: red;" color:red>*</b></label>
