...
<body class="main11">
  <div class="div0">
        <div class="div11" >
            ...
            PreparedStatement pstmt=con.prepareStatement("INSERT INTO LIBRARY VALUES(?,?)",ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            pstmt.setString(1,libraryName);
            pstmt.setString(2,desc);
            pstmt.executeUpdate();
            %>
           <a style="align:center text-decoration:none" href="addLibrary.jsp">Add another Library</a> 
