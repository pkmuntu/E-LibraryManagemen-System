...
<body class="main11">
  <div class="div0">
        <div class="div11" >
            <h4>Library Report</h4><hr><br><br>
            
              <%
                            Connection con=(Connection)application.getAttribute("oracle");  
                            Statement stmt=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
                              ResultSet rs=stmt.executeQuery("SELECT ROWNUM AS SNO,LIBNAME AS Library,DESCRIPTION FROM LIBRARY");
              ...
              <p>Total number of Library is <%while(rs1.next()) {%> <%=rs1.getInt(1) %><%} %></p>
