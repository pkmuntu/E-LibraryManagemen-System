...
<body class="main11">
  <div class="div0">
        <div class="div11" >
            ...
            PreparedStatement pstmt=con.prepareStatement("INSERT INTO PUBLICATIONS VALUES(?,?,?,?,?)",ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            pstmt.setString(1,publicationName);
            pstmt.setLong(2,Long.parseLong(phoneNo));
            pstmt.setString(3,email);
            pstmt.setString(4,address);
            pstmt.setString(5,desc);
            pstmt.executeUpdate();
            %>
           <a style="align:center text-decoration:none" href="addPublication.jsp">Add another Publication</a> 
