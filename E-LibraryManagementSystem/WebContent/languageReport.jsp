...
<body class="main11">
  <div class="div0">
        <div class="div11" >
            <h4>Language Report</h4><hr><br><br>
            
              <%
                            Connection con=(Connection)application.getAttribute("oracle");  
                            Statement stmt=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
                              ResultSet rs=stmt.executeQuery("SELECT ROWNUM AS SNO,LANGNAME AS LANGUAGE,DESCRIPTION,(SELECT COUNT(*) FROM BOOKS WHERE LANGUAGE=L.LANGNAME) AS BOOKS FROM LANGUAGES L");
              ...
              <%ResultSet rs1=stmt.executeQuery("SELECT COUNT(*) FROM LANGUAGES"); %>
              <p>Total number of language in book <%while(rs1.next()) {%> <%=rs1.getInt(1) %><%} %></p>
