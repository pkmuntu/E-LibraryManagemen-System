...
<body class="main11">
  <div class="div0">
        <div class="div11" >
            <h4>Add Author Form</h4>Add Author Form<hr><br>
             <form action="setAuthor.jsp">
                  
                <div class="form-group col-md-6">
                    <label for="">First Name<b style="color: red;" color:red>*</b></label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="">Last Name<b style="color: red;" color:red>*</b></label>
