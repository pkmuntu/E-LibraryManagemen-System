...
<body class="main11">
  <div class="div0">
        <div class="div11" >
            ...
            PreparedStatement pstmt=con.prepareStatement("INSERT INTO USERS VALUES(U.NEXTVAL,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
            ...
            pstmt.executeUpdate();
            %>
           <a style="align:center text-decoration:none" href="addUser.jsp">Add another User</a> 
