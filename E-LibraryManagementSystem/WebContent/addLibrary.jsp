...
<body class="main11">
  <div class="div0">
        <div class="div11" >
            <h4>Library Added</h4><hr><br>
              <form action="setLibrary.jsp">
                
              
                <div class="form-group col-md-6">
                <label for="text">Library Name<b style="color: red;" color:red>*</b></label>
                <input type="text" class="form-control" name="libraryName"  required>
                </div>
                <div class="form-group col-md-6">
